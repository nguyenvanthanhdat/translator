...
if __name__ == '__main__':
    ...
    parser.add_argument('--craw_finetune_path', default='data/craw/finetune', required=True)
    parser.add_argument('--output_finetune_path', default='data/interim/finetune', required=True)
